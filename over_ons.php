...
<main>
    ...
    <h1 class="title">
        Slideshow Foto's KidzGlobe
    </h1>
    <p>Welkom bij de site van KidzGlobe. KidzGlobe is een kinderopvangverblijf in Rotterdam Zuid. Als je je kind kwijt wilt kan je hier een reservering maken.</p>
